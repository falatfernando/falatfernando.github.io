...
export const translations: Record<'pt' | 'en', TranslationSchema> = {
  pt: {
    ...
    hero: {
      ...
      titleFirst: 'Olá! Eu sou',
      titleAccent: 'Cientista de Dados Genômicos',
      titleSecond: '& Arquiteto Sênior de Soluções',
      subtitle: 'Prazer, sou o Fernando. Unindo a paixão pela Bioinformática e a Ciência de Dados à Engenharia de Software para construir não só sistemas complexos, mas soluções reais que fazem a diferença na área corporativa e científica.',
  ...
  en: {
    ...
    hero: {
      ...
      titleAccent: 'Genomic Data Scientist',
      titleSecond: '& Senior Solutions Architect',
      subtitle: 'Nice to meet you, I\'m Fernando. I combine a deep passion for Bioinformatics and Data Science with robust Software Engineering to build not just complex systems, but real-world solutions that bridge the gap between science and enterprise.',
